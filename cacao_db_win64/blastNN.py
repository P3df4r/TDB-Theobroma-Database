...
nt = input()
blastn1 = "C:/Program Files/NCBI/blast-2.10.1+/bin/blastn"
...
time_S = time.time()
code = NcbiblastnCommandline(cmd=blastn1, query=query, subject=nt, strand="plus", evalue=0.001, outfmt=5, out=output)
