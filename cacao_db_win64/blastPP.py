...
nt = input()
blastp1 = "C:/Program Files/NCBI/blast-2.10.1+/bin/blastp"
...
time_S = time.time()
code = NcbiblastpCommandline(cmd=blastp1, query=query, subject=nt, strand="plus", evalue=0.001, outfmt=5, out=output)
