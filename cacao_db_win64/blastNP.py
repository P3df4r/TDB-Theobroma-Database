...
nt = input()
blastn1 = "C:/Program Files/NCBI/blast-2.10.1+/bin/blastx"
...
time_S = time.time()
code = NcbiblastxCommandline(cmd=blastp1, query=query, subject=nt, strand="plus", evalue=0.001, outfmt=5, out=output)
