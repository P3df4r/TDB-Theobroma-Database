...
export async function fetchGenomesFile(genomesFileLocation) {
    const genomesFileText = await openLocation(genomesFileLocation).readFile('utf8');
...
export function generateTracks(trackDb, trackDbFileLocation, assemblyName, sequenceAdapter) {
    const tracks = [];
