...
export default function UCSCTrackHubConnection(pluginManager) {
    return types.compose('UCSCTrackHubConnection', BaseConnectionModelFactory(pluginManager), types
        .model({
        ...
        connect() {
            ...
            fetchHubFile(hubFileLocation)
                ...
                for (const [genomeName, genome] of genomesFile) {
                    ...
                    const assemblyConf = session.assemblies.find(assembly => readConfObject(assembly, 'name') === genomeName);
                    if (!assemblyConf) {
                ...
                for (const [trackDbFileLocation, trackDbFile, genomeName, assemblyConf,] of trackDbData) {
                    ...
                    const tracks = generateTracks(trackDbFile, trackDbFileLocation, genomeName, sequenceAdapter);
