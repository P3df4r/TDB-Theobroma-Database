...
const ElisionRulerArc = observer(({ model, slice }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(RulerLabel, { text: regionCountString, view: model, maxWidthPx: widthPx, radians: centerRadians, radiusPx: radiusPx, title: `${Number(
            // @ts-ignore
...
const CircularRuler = observer(({ model, slice }) => {
    if (slice.region.elided) {
        return (React.createElement(ElisionRulerArc, { key: 
            /* @ts-ignore */
            assembleLocString(slice.region.regions[0]), model: model, slice: slice }));
    }
