...
function SvgFeatureRendering(props) {
    ...
    if (exportSVG) {
        return (React.createElement(RenderedFeatures, { displayMode: displayMode, isFeatureDisplayed: featureDisplayHandler, region: region, ...props }));
    }
    return (React.createElement("svg", { ref: ref, "data-testid": "svgfeatures", width: width, height: height + svgHeightPadding, onMouseDown: mouseDown, onMouseUp: mouseUp, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, onMouseOver: onMouseOver, onMouseOut: onMouseOut, onMouseMove: mouseMove, onClick: click },
