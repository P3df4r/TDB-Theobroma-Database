...
const LinearGenomeViewHeader = (0, mobx_react_1.observer)(({ model }) => {
    return !model.hideHeader ? (model.hideHeaderOverview ? (react_1.default.createElement(Controls, { model: model })) : (react_1.default.createElement(OverviewScaleBar_1.default, { model: model },
