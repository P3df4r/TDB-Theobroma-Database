...
exports.renderBlockData = void 0;
...
const blockState = mobx_state_tree_1.types
    ...
    return {
        ...
        beforeDestroy() {
            ...
            if (renderArgs) {
                rendererType
                    .freeResourcesInClient(rpcManager, JSON.parse(JSON.stringify(renderArgs)))
                    .catch((e) => {
...
function renderBlockData(self, optDisplay) {
    try {
        ...
        if (!assemblyNames.includes(regionAsm) &&
            !assemblyNames.find(name => { var _a; return (_a = assemblyManager.get(name)) === null || _a === void 0 ? void 0 : _a.hasName(regionAsm); })) {
...
//# sourceMappingURL=serverSideRenderedBlock.js.map