...
var _ee = _interopRequireDefault(require("@librpc/ee"));
...
class RpcClient extends _ee.default {
  /**
  ...
  reject(uid, error) {
    if (this.errors[uid]) {
      this.errors[uid]((0, _serializeError.deserializeError)(error));
      this.clear(uid);
    }
  }
  /**
