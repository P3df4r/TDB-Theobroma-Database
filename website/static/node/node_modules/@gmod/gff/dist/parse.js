...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype._emitAllUnderConstructionFeatures = function () {
        ...
        if (Array.from(Object.values(this._underConstructionOrphans)).length) {
            throw new Error("some features reference other features that do not exist in the file (or in the same '###' scope). ".concat(Object.keys(this._underConstructionOrphans)));
        }
    };
    ...
    Parser.prototype._bufferLine = function (line) {
        ...
        var derives = this.disableDerivesFromReferences
            ? []
