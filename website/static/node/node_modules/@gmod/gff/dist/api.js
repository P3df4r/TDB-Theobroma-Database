...
function _processParseOptions(options) {
    var out = __assign({ encoding: 'utf8', parseFeatures: true, parseDirectives: false, parseSequences: true, parseComments: false, bufferSize: 1000, disableDerivesFromReferences: false }, options);
    if (options.parseAll) {
