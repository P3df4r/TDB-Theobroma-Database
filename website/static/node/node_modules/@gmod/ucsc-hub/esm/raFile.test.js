...
describe('RaFile reader', () => {
    ...
    it('deletes a stanza', () => {
        ...
        expect(raFile.nameKey).toEqual('key1');
        expect(raFile.toString()).toEqual(fs.readFileSync('test/afterDelete.ra', 'utf8'));
    });
    it('clears', () => {
        const raFile = new RaFile(fs.readFileSync('test/basic.ra', 'utf8'));
        raFile.clear();
    ...
    it('throws if stanzas have mismatched keys', () => expect(() => new RaFile(fs.readFileSync('test/mismatchKeys.ra', 'utf8'))).toThrow(/must have the same key/));
    it('throws if stanzas have duplicate names', () => expect(() => new RaFile(fs.readFileSync('test/duplicateName.ra', 'utf8'))).toThrow(/duplicate stanza name/));
});
