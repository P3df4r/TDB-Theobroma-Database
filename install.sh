...
cp /website/static/dados/Matina_old/prep-database.py /website/static/dados/Matina_old/
...
samtools faidx website/static/dados/Matina_old/Matina.fasta -o website/static/dados/Matina_old/Matina.fasta.fai
bash website/static/dados/Matina_old/pre-database.sh Matina
...
cp config.json /website/static/dados/Criollo_new/config.json
...
jbrowse add-assembly /website/static/dados/Matina_old/Matina.fasta --load inPlace
jbrowse add-track /website/static/dados/Matina_old/Matina.gff --load inPlace
cp config.json /website/static/dados/Matina_old/config.json
sed 's/Matina.fasta/../static/dados/Matina_old/Matina.fasta/g' /website/static/dados/Matina_old/config.json > /website/static/dados/Matina_old/config1.json
sed 's/Matina.fasta.fai/../static/dados/Matina_old/Matina.fasta.fai/g' /website/static/dados/Matina_old/config1.json > /website/static/dados/Matina_old/config2.json
sed 's/Matina.gff/../static/dados/Matina_old/Matina.gff/g' /website/static/dados/Matina_old/config2.json > /website/static/dados/Matina_old/config.json
rm config.json
...
cp config.json /website/static/dados/C1074/config.json
